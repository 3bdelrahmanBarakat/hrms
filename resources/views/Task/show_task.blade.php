																	...
																	<div class="task-container">
																		<span class="task-action-btn task-check">
																			<span class="action-circle large complete-btn" title="Mark Complete">
																				<form action="{{route('task.uncheck', $task->id)}}" method="POST">
                                                                                    @csrf
                                                                                    @method('PUT')
														...
														<div class="task-list-footer">
															<div class="new-task-wrapper">
                                                                <form action="{{route('task.store')}}" method="POST">
                                                                    ...
                                                                    {{-- <textarea name="name" id="new-task" placeholder="Enter new task here. . ."></textarea> --}}
                                                                    <label for="tsk">Task name:</label>
                                                                    <input type="text" class="form-control" name="name" id="tsk">
                                                                    ...
                                                                    <button style="border: none"><span class="add-new-task-btn btn" id="add-task">Add Task</span></button>
