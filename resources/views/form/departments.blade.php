                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                       data-id="{{ $department->id }}" data-department="{{ $department->department }}"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="{{route('form/departments/update')}}" method="POST">
									...
									<div class="form-group">
										<label>Department Name <span class="text-danger">*</span></label>
										<input class="form-control" id="department_edit" name="department" value="" type="text">
									</div>
									<div class="submit-section">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{route('form/departments/update')}}" method="post" autocomplete="off">
                                            @csrf
                                            <div class="form-group">
