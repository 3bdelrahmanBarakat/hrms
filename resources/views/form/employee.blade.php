								...
								<table class="table table-striped custom-table mb-0 datatable">
									...
									<tbody>
										...
										<tr>
                                            ...
                                            <td>{{$employee->schedules->first()->schedule_name}}</td>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                       data-id="{{ $employee->id }}" data-employee="{{ $employee->employee }}"
                                                        data-toggle="modal" href="#exampleModal2"
                                                       title="تعديل"><i class="fa fa-pencil m-r-5"></i>Edit</a>
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form action="{{route('form/employees/store')}}" method="POST">
                                    @csrf
									<div class="form-group">
										<label>Employee Name <span class="text-danger">*</span></label>
										<input class="form-control" @error('employee') is-invalid @enderror type="text" id="employee" name="name">
									</div>
									<div class="form-group">
										<label>Position <span class="text-danger">*</span></label>
										<input class="form-control" @error('employee') is-invalid @enderror type="text" id="position" name="position">
									</div>
									<div class="form-group">
										<label>Employee Email <span class="text-danger">*</span></label>
										<input class="form-control" @error('employee') is-invalid @enderror type="text" id="email" name="email">
									</div>
									...
									<div class="form-group">
                                        ...
                                        <select class="form-control" id="schedule" name="schedule_id" required>
                                            <option value="" selected>- Select -</option>
                                            @foreach($schedules as $schedule)
                                            <option value="{{$schedule->id}}">{{$schedule->schedule_name}} -> from {{$schedule->time_in}}
									...
									<div class="form-group">
                                        <label for="schedule" class="col-sm-3 control-label">Departments</label>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{route('form/employees/update')}}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label>Employee Name <span class="text-danger">*</span></label>
                                                <input class="form-control" @error('employee') is-invalid @enderror type="text" id="employee" name="employee">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="schedule" name="schedule" required>
                                                    <option value="" selected>- Select -</option>
                                                    @foreach($schedules as $schedule)
                                                    <option value="{{$schedule->schedule_name}}">{{$schedule->schedule_name}} -> from {{$schedule->time_in}}
                                                        to {{$schedule->time_out}} </option>
                                                    @endforeach
