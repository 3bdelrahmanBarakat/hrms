...
<html lang="en">
    <head>
        ...
        <title>schedules - HRMS admin template</title>
    ...
    <body>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                       data-id="{{ $schedule->id }}" data-schedule="{{ $schedule->schedule_name }}" data-timein="{{ $schedule->time_in}}" data-timeout="{{ $schedule->time_out}}"
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="{{route('form/employees/schedule/save')}}" method="POST">
                                    @csrf
									<div class="form-group">
										<label>Schedule Name <span class="text-danger">*</span></label>
										<input class="form-control" id="name" name="schedule_name" type="text">
									</div>
				...
				{{-- <div id="edit_schedule" class="modal custom-modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="{{route('form/employees/schedule/update')}}" method="POST">
                                    @csrf
									<div class="form-group">
										<label>Schedule Name <span class="text-danger">*</span></label>
										<input class="form-control" id="name" value=""  name="schedule_name" type="text">
									</div>
                                    ...
                                    <div class="form-group">
                                        <label for="time_in" class="col-sm-3 control-label">Time In</label>
                                            ...
                                            <div class="bootstrap-timepicker">
                                                <input type="time" class="form-control timepicker" id="time_in" value="" name="time_in" required>
                                            </div>
                        ...
                        <label for="time_out" class="col-sm-3 control-label">Time Out</label>
                            ...
                            <div class="bootstrap-timepicker">
                                <input type="time" class="form-control timepicker" value="" id="time_out" name="time_out" required>
                            </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{route('form/employees/schedule/update')}}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="schedule_name"   name="schedule_name" type="text">
                                            </div>
        ...
        {{-- <script>
            $('#exampleModal2').on('show.bs.modal', function(event) {
                ...
                modal.find('.modal-body #schedule_name').val(schedule);
                modal.find('.modal-body #time_in').val(timein);
                modal.find('.modal-body #time_out').val(timeout);
            })
        </script> --}}
