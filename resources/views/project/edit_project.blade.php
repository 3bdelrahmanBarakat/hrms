								...
								<form action="{{route('project.update', $project->id)}}" method="POST">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<select name="client_id" class="select">
                                                    <option selected value="{{$project->client_id}}">{{$project->client_id}}</option>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="cal-icon">
													<input value="{{$project->start_date}}" placeholder="{{$project->start_date}}" name="start_date" class="form-control datetimepicker" type="text">
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="cal-icon">
													<input value="{{$project->end_date}}" placeholder="{{$project->end_date}}" name="end_date" class="form-control datetimepicker" type="text">
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-3">
											<div class="form-group">
												<label>Rate</label>
												<input name="rate" value="{{$project->rate}}" placeholder="{{$project->rate}}" class="form-control" type="text">
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												<label>&nbsp;</label>
												<select name="rate_type" class="select">
													<option selected>{{$project->rate_type}}</option>
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<select name="priority" class="select">
                                                    <option selected>{{$project->priority}}</option>
													<option>High</option>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
                                                ...
                                                <select name="team_leader_id" class="select" selected>
                                                    @foreach ($employees as $employee)
                                                        <option value="{{ $employee->id }}" {{ $employee->id == $project->team_leader_id ? 'selected' : '' }}>
                                                            {{ $employee->name }}
                                                        </option>
                                                    @endforeach
												</select>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
                                                ...
                                                <select name="employee_ids[]" class="select" multiple>
                                                    @foreach ($employees as $employee)
                                                    <option value="{{ $employee->id }}" {{ in_array($employee->id, $currentEmployees) ? 'selected' : '' }}>
                                                        {{ $employee->name }}
                                                    </option>
                                                     @endforeach
                                                    {{-- <option selected value="{{$project->employees->first()->id}}">{{$project->employees->first()->name}}</option>
									...
									<div class="form-group">
										...
										<textarea name="description" rows="4" class="form-control summernote" placeholder="{{$project->description}}">{{$project->description}}</textarea>
									</div>
