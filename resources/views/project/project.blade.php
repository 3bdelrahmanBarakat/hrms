								...
								<div class="card-body">
									...
									<div class="project-members m-b-15">
										...
										<ul class="team-members">
											<li>
												<a href="#" data-toggle="tooltip" title="{{$project->teamLeader()->first()->name}}">{{$project->teamLeader()->first()->name}}</a>
											</li>
										</ul>
									</div>
									<div class="project-members m-b-15">
										...
										<ul class="team-members">
											<li>
												<a href="#" data-toggle="tooltip">{{$project->employees()->first()->name}}</a>
											</li>
									...
									{{-- <div class="project-members m-b-15">
										...
										<ul class="team-members">
											<li>
												<a href="#" data-toggle="tooltip">{{$project->clients}}</a>
											</li>
